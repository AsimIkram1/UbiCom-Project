...
public class PluggedInService extends Service {
        ...
        if(batteryCharge)
        {
            ...
            NotificationCompat.Builder mBuilder =
                    new NotificationCompat.Builder(this)
                            ...
                            .setContentTitle("Mark Location")
                            .setContentText("Please Open App");

            Intent notificationIntent = new Intent(getApplicationContext(),BatteryTest.class);
